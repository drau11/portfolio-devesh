...
export const SITE_CONTENT: SiteContent = {
  ...
  experience: [
    ...
    },
    {
      ...
      endDate: "November 2024",
      summary: [
        "Providing high standards of customer service during high- volume, fast-paced operations.",
        "Resolved complaints promptly and professionally Cross- trained and coordinated scheduling with team members to ensure seamless service.",
      ],
    },
  ],
  certifications: [
